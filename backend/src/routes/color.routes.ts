 ...
 */
router.get('/search', validateQuery(colorSearchSchema), searchColors);
 ...
 * @access  Private (Authenticated users)
 */
router.get('/families', getColorFamilies);
 ...
 * @access  Private (Authenticated users)
 */
router.post('/bulk-import', validateBody(colorBulkImportSchema), bulkImportColors);
 ...
 * @access  Private (Authenticated users)
 */
router.post('/', validateBody(createColorSchema), createColor);
 ...
 * @access  Private (Authenticated users)
 */
router.get('/', validateQuery(colorQuerySchema), getAllColors);
 ...
 * @access  Private (Authenticated users)
 */
router.get('/:id', validateParams(colorIdParamSchema), getColorById);
 ...
 * @access  Private (Authenticated users)
 */
router.put('/:id', validateParams(colorIdParamSchema), validateBody(updateColorSchema), updateColor);
 ...
 * @access  Private (Authenticated users)
 */
router.delete('/:id', validateParams(colorIdParamSchema), deleteColor);
