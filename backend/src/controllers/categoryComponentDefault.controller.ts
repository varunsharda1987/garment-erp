 ...
 */
export const getDefaultComponents = async (req: Request, res: Response): Promise<void> => {
  const { id } = req.params;
 ...
 */
export const getSuggestedComponents = async (req: Request, res: Response): Promise<void> => {
  const { id } = req.params;
 ...
 */
export const setDefaultComponents = async (req: Request, res: Response): Promise<void> => {
  const { id } = req.params;
 ...
 */
export const addDefaultComponent = async (req: Request, res: Response): Promise<void> => {
  const { id } = req.params;
  const data = req.body;
 ...
 */
export const updateDefaultComponent = async (req: Request, res: Response): Promise<void> => {
  ...
  if (!existing) {
    throw new NotFoundError('Default component not found for this category');
  }
 ...
 */
export const removeDefaultComponent = async (req: Request, res: Response): Promise<void> => {
  const { categoryId, componentId } = req.params;
 ...
 */
export const getCategoriesUsingComponent = async (req: Request, res: Response): Promise<void> => {
  const { id } = req.params;
