...
| **BH-0070** | CONFIRMED | `backend/src/config/company.config.ts:107` (`amountToWords`) | Amount-in-words on every invoice/proforma disagrees with the printed numeral — amountToWords() rounds paise away, and there is no Round-Off line |
