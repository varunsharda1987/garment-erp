...
2. [Enums (24)](#enums)
3. [Tables (50)](#tables)
4. [Style Master Module (13 tables)](#style-master-module)
...
BUYER
```
*Note: Only BUYER type is active. Suppliers have a separate module.*
...
The Style Master module is the core of the production tracking system with **13 interconnected tables**.
...
- **style_size_breakdown** (`StyleSizeBreakdown`) - 7 fields
- **style_production_tracking** (`StyleProductionTracking`) - 25 fields
- **style_orders** (`StyleOrder`) - 14 fields
