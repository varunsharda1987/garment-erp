...
export const NAV_GROUPS: NavGroup[] = [
  // 1. Pre-Production (new group below Styles)
  {
    ...
    items: [
      ...
      { title: 'Fabric Costing', path: '/fabric-costing', iconName: 'Calculator', permission: 'costSheets', badge: 'TEST' },
  ...
  // 3. Procurement (moved above Manufacturing)
  {
    ...
    items: [
      { title: 'Requirements', path: '/procurement/requirements', iconName: 'FileBarChart', permission: 'mrp', keywords: ['mrp', 'material', 'service', 'requirement', 'procurement'] },
      { title: 'Purchase Orders', path: '/procurement/purchase-orders', iconName: 'ShoppingCart', permission: 'purchaseOrders' },
  ...
  // 5. Manufacturing (Testing moved here from Orders & Planning)
  {
    ...
    items: [
      ...
      { title: 'Processing Batches', path: '/processing/batches', iconName: 'ClipboardList', permission: 'processingBatches' },
      'divider',
  ...
  // 6. Inventory
  {
    ...
    iconName: 'Warehouse',
    items: [
      { title: 'Inventory Dashboard', path: '/inventory/dashboard', iconName: 'BarChart3', permission: 'inventoryDashboard' },
      ...
      'divider',
      { title: 'Stock In', path: '/inventory/movements/stock-in', iconName: 'PackagePlus', permission: 'stockMovements' },
      { title: 'Stock Out', path: '/inventory/movements/stock-out', iconName: 'PackageX', permission: 'stockMovements' },
      { title: 'Stock Transfer', path: '/inventory/movements/transfer', iconName: 'Truck', permission: 'stockMovements' },
      { title: 'Stock Adjustment', path: '/inventory/movements/adjustment', iconName: 'Scale', permission: 'stockMovements' },
    ],
  },
  // 7. Materials & Masters (merged)
  {
    ...
    items: [
      ...
      { title: 'Size Categories', path: '/masters/size-categories', iconName: 'Ruler', permission: 'sizeCategoryMaster' },
      ...
      { title: 'Product Categories', path: '/product-categories', iconName: 'FolderTree', permission: 'productCategories' },
      { title: 'Processor Rate Cards', path: '/processor-rate-cards', iconName: 'FileSpreadsheet', permission: 'suppliers' },
  ...
  // 9. Reports & Finance
  {
    ...
    items: [
      { title: 'Style-Fabric Report', path: '/reports/style-fabric', iconName: 'FileSpreadsheet', permission: 'reports' },
  ...
  // 10. Administration (merged Admin + Settings)
  {
    ...
    items: [
      ...
      { title: 'Override History', path: '/admin/override-history', iconName: 'ShieldAlert', permission: 'overrideHistory' },
    ],
  },
