...
const SEEDS: SeedEntry[] = [
  ...
  { prefix: "GEN", table: "material_master", column: "code", suffixRegex: "^GEN(\\d+)$" },
  { prefix: "FAB", table: "material_master", column: "code", suffixRegex: "^FAB(\\d+)$" },
  { prefix: "GRG", table: "material_master", column: "code", suffixRegex: "^GRG(\\d+)$" },
  { prefix: "TRM", table: "material_master", column: "code", suffixRegex: "^TRM(\\d+)$" },
  { prefix: "LAC", table: "material_master", column: "code", suffixRegex: "^LAC(\\d+)$" },
  { prefix: "BTN", table: "material_master", column: "code", suffixRegex: "^BTN(\\d+)$" },
  { prefix: "THR", table: "material_master", column: "code", suffixRegex: "^THR(\\d+)$" },
  { prefix: "ZIP", table: "material_master", column: "code", suffixRegex: "^ZIP(\\d+)$" },
  { prefix: "ELA", table: "material_master", column: "code", suffixRegex: "^ELA(\\d+)$" },
  { prefix: "LBL", table: "material_master", column: "code", suffixRegex: "^LBL(\\d+)$" },
  { prefix: "HKE", table: "material_master", column: "code", suffixRegex: "^HKE(\\d+)$" },
  { prefix: "SNP", table: "material_master", column: "code", suffixRegex: "^SNP(\\d+)$" },
  { prefix: "BCK", table: "material_master", column: "code", suffixRegex: "^BCK(\\d+)$" },
  { prefix: "BLT", table: "material_master", column: "code", suffixRegex: "^BLT(\\d+)$" },
  { prefix: "VLC", table: "material_master", column: "code", suffixRegex: "^VLC(\\d+)$" },
  { prefix: "DRS", table: "material_master", column: "code", suffixRegex: "^DRS(\\d+)$" },
  { prefix: "RBN", table: "material_master", column: "code", suffixRegex: "^RBN(\\d+)$" },
  { prefix: "SEQ", table: "material_master", column: "code", suffixRegex: "^SEQ(\\d+)$" },
  { prefix: "BED", table: "material_master", column: "code", suffixRegex: "^BED(\\d+)$" },
  { prefix: "MTF", table: "material_master", column: "code", suffixRegex: "^MTF(\\d+)$" },
  { prefix: "INT", table: "material_master", column: "code", suffixRegex: "^INT(\\d+)$" },
  { prefix: "PAD", table: "material_master", column: "code", suffixRegex: "^PAD(\\d+)$" },
  { prefix: "PKG", table: "material_master", column: "code", suffixRegex: "^PKG(\\d+)$" },
  { prefix: "ACC", table: "material_master", column: "code", suffixRegex: "^ACC(\\d+)$" },
  { prefix: "SVC", table: "material_master", column: "code", suffixRegex: "^SVC(\\d+)$" },
  { prefix: "MPN", table: "material_master", column: "code", suffixRegex: "^MPN(\\d+)$" },
  { prefix: "OTR", table: "material_master", column: "code", suffixRegex: "^OTR(\\d+)$" },
  { prefix: "OFS", table: "material_master", column: "code", suffixRegex: "^OFS(\\d+)$" },
  { prefix: "OTP", table: "material_master", column: "code", suffixRegex: "^OTP(\\d+)$" },
  { prefix: "ODC", table: "material_master", column: "code", suffixRegex: "^ODC(\\d+)$" },
  { prefix: "OFN", table: "material_master", column: "code", suffixRegex: "^OFN(\\d+)$" },
  { prefix: "OTH", table: "material_master", column: "code", suffixRegex: "^OTH(\\d+)$" },
