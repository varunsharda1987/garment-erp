...
class WarehouseService {
     ...
     */
    async getWarehouseByCode(warehouseCode) {
        const warehouse = await prisma.warehouses.findUnique({
            where: { warehouseCode },
            include: {
                users: {
     ...
     */
    async getWarehouseStockSummary(id) {
        const warehouse = await prisma.warehouses.findUnique({
            where: { id },
            include: {
                stock_levels: {
     ...
     */
    async getWarehousesByType(warehouseType) {
        const warehouses = await prisma.warehouses.findMany({
            where: {
                warehouseType,
                isActive: true,
     ...
     */
    async generateWarehouseCode(warehouseType) {
