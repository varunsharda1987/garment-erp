...
3. Read the five cards: **Total Orders**, **Running**, **Delayed**, **Needs Attention**, **Completed**.
4. Narrow the list with the filter bar:
   ...
   - **Sort By** — Order Date, Delivery Date, Status, Progress, Order Value. Click **Ascending / Descending** to flip.
5. Click **Refresh** to pull fresh numbers. The line above it shows when the page last updated.
