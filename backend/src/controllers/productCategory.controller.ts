 ...
 */
export const getProductCategoryHierarchy = async (req: Request, res: Response): Promise<void> => {
 ...
 */
export const getProductCategoryChildren = async (req: Request, res: Response): Promise<void> => {
  const { id } = req.params;
 ...
 */
export const getProductCategoryPath = async (req: Request, res: Response): Promise<void> => {
  const { id } = req.params;
 ...
 */
export const reorderProductCategories = async (req: Request, res: Response): Promise<void> => {
 ...
 */
export const toggleProductCategoryActive = async (req: Request, res: Response): Promise<void> => {
  const { id } = req.params;
