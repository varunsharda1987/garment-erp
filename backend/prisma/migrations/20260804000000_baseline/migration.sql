...
-- CreateEnum
CREATE TYPE "StyleImageType" AS ENUM ('MAIN', 'SKETCH_FRONT', 'SKETCH_BACK', 'SKETCH_SIDE', 'TECHNICAL_FLAT', 'DETAIL_VIEW', 'CONSTRUCTION', 'OTHER');
...
-- CreateEnum
CREATE TYPE "CustomerAddressType" AS ENUM ('SHIP_TO', 'COURIER', 'OFFICE');
...
-- CreateEnum
CREATE TYPE "GRNStatus" AS ENUM ('PENDING_QC', 'ACCEPTED', 'REJECTED', 'PARTIALLY_ACCEPTED', 'REVERSED');
...
-- CreateEnum
CREATE TYPE "CadApprovalStatus" AS ENUM ('PENDING', 'APPROVED', 'REJECTED', 'ALTERNATE_APPROVED');
...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'IN_PRODUCTION', 'COMPLETED', 'DISPATCHED', 'CANCELLED', 'SPLIT');
...
-- CreateEnum
CREATE TYPE "ProductionStage" AS ENUM ('CUTTING', 'STITCHING', 'FINISHING', 'CHECKING', 'PACKING', 'ORDER_RECEIVED', 'PENDING_COSTING', 'PENDING_GREIGE_ORDER', 'TRIMS_NOT_ORDERED', 'IN_PRINTING', 'IN_DYING', 'IN_EMBROIDERY', 'IN_HANDWORK', 'IN_CUTTING', 'IN_STITCHING', 'IN_FINISHING', 'IN_SMOCKING', 'READY_TO_SHIP', 'SHIPPED', 'COMPLETED');
...
-- CreateEnum
CREATE TYPE "POCategory" AS ENUM ('FABRIC', 'GREIGE', 'PROCESSING', 'TRIMS', 'THREAD', 'LACE', 'GREIGE_LACE', 'LACE_PROCESSING', 'GENERAL', 'BUTTON', 'ZIPPER', 'ELASTIC', 'LABEL', 'PACKAGING', 'MACHINE_PART', 'OTHER_MATERIAL', 'EMBROIDERY_SERVICE', 'WASHING_SERVICE', 'FINISHING_SERVICE', 'CUTTING_SERVICE', 'STITCHING_SERVICE', 'HANDWORK_SERVICE', 'SMOCKING_SERVICE', 'TRANSPORTATION_SERVICE');

-- CreateEnum
CREATE TYPE "POSource" AS ENUM ('MANUAL', 'COST_SHEET', 'MRP', 'SERVICE_REQUIREMENT', 'PRODUCTION_RUN');
...
-- CreateEnum
CREATE TYPE "SupplierCategory" AS ENUM ('FABRIC_SUPPLIER', 'GREIGE_SUPPLIER', 'TRIMS_SUPPLIER', 'THREAD_SUPPLIER', 'PACKAGING_SUPPLIER', 'LACE_SUPPLIER', 'DYEING_PRINTING', 'EMBROIDERY', 'HAND_WORK', 'SMOCKING', 'CMT_UNIT', 'FINISHING_CONTRACTOR', 'STITCHING_CONTRACTOR', 'WASHING', 'DORI_PIPING_CONTRACTOR', 'MACHINE_PARTS_SUPPLIER', 'OTHER_SERVICES');
...
-- CreateEnum
CREATE TYPE "Unit" AS ENUM ('METER', 'PIECE', 'KILOGRAM', 'SET', 'YARD', 'DOZEN', 'GROSS', 'TUBE', 'CONE', 'SPOOL', 'BOX', 'PAIR', 'PACK', 'GRAM', 'LITER', 'ROLL');

-- CreateEnum
CREATE TYPE "MaterialType" AS ENUM ('GENERIC', 'TRIMS', 'LACE', 'BUTTON', 'THREAD', 'ZIPPER', 'ELASTIC', 'LABEL', 'PACKAGING', 'ACCESSORIES', 'SERVICE', 'MACHINE_PART', 'OTHER', 'FABRIC', 'GREIGE', 'HOOK_EYE', 'SNAP_BUTTON', 'BUCKLE', 'BELT', 'VELCRO', 'DRAWSTRING', 'RIBBON', 'SEQUIN', 'BEAD', 'MOTIF', 'INTERLINING', 'PADDING', 'OTHER_FASTENER', 'OTHER_TAPE', 'OTHER_DECORATIVE', 'OTHER_FUNCTIONAL', 'OTHER_MATERIAL');
...
-- CreateEnum
CREATE TYPE "MaterialRequirementStatus" AS ENUM ('PENDING', 'FULFILLED_STOCK', 'PARTIAL_STOCK', 'PO_REQUIRED', 'PO_GENERATED', 'PO_SENT', 'PARTIALLY_RECEIVED', 'RECEIVED', 'CANCELLED');
...
-- CreateEnum
CREATE TYPE "BuyerApprovalStatus" AS ENUM ('NOT_SENT', 'PENDING', 'APPROVED', 'REJECTED', 'RESUBMIT_REQUIRED');
...
-- CreateTable
CREATE TABLE "delivery_note_fg_allocations" (
    "id" TEXT NOT NULL,
    "deliveryNoteId" TEXT NOT NULL,
...
CREATE TABLE "grn_items" (
    ...
    "receivedWidthInches" DECIMAL(5,2),
    "entryMode" VARCHAR(20),
    "baleCount" INTEGER,
    "thanCount" INTEGER,
    "rollCount" INTEGER,
    "totalMeters" DECIMAL(10,3),
    "isOverReceipt" BOOLEAN NOT NULL DEFAULT false,
    "overReceiptQty" DECIMAL(10,3),
    "receivedAsReadyFabric" BOOLEAN NOT NULL DEFAULT false,
    "actualRatePerUnit" DECIMAL(12,2),
    "updateFutureSourcing" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "purchase_orders" (
    ...
    "originalDeliveryLocationId" TEXT,
    "deliveryLocationAmendedAt" TIMESTAMP(3),
    "deliveryLocationAmendedById" TEXT,
...
CREATE TABLE "style_costing_fabric_items" (
    ...
    "cadWastagePercent" DECIMAL(5,2) NOT NULL DEFAULT 0,
...
CREATE TABLE "style_production_tracking" (
    ...
    "piecesInSmocking" INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE "processor_rate_card" (
    ...
    "effectiveTo" TIMESTAMP(3),
    "supersededById" TEXT,
    "previousRateValue" DECIMAL(10,2),
...
-- CreateTable
CREATE TABLE "processor_rate_change_log" (
    "id" TEXT NOT NULL,
...
CREATE TABLE "work_orders" (
    ...
    "orderId" TEXT,
    "orderItemId" TEXT,
    "stockProductionOrderId" TEXT,
    "stockProductionOrderItemId" TEXT,
    "styleId" TEXT NOT NULL,
    "warehouseId" TEXT,
...
CREATE TABLE "greige_master" (
    ...
    "averageShrinkagePercent" DECIMAL(5,2),
    "gsmRange" TEXT,
    "costPerMeter" DECIMAL(10,2),
    "moq" INTEGER,
    "leadTimeDays" INTEGER,
...
CREATE TABLE "greige_stock_transaction" (
    ...
    "transactionType" "SpecializedStockTransactionType" NOT NULL,
...
CREATE TABLE "fabric_width_cad" (
    ...
    "approval_notes" TEXT,
    "approval_status" "CadApprovalStatus" DEFAULT 'PENDING',
...
-- CreateTable
CREATE TABLE "fabric_costing_run" (
    "id" TEXT NOT NULL,
    "styleId" TEXT NOT NULL,
...
CREATE TABLE "fabric_stock" (
    ...
    "originOrderId" TEXT,
    "status" "StockStatus" NOT NULL DEFAULT 'AVAILABLE',
    "stockType" "StockEntryType" NOT NULL DEFAULT 'EXCESS',
    ...
    "pattern_part_id" TEXT,
    "fabricFinishType" "FabricFinishType",
    "needsEmbroidery" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "lace_master" (
    ...
    "processedForStyleId" TEXT,
    "processedForStyleCode" TEXT,
...
CREATE TABLE "order_thread_requirements" (
    ...
    "unitPrice" DECIMAL(10,2),
    "totalCost" DECIMAL(10,2),
    "status" "ThreadRequirementStatus" NOT NULL DEFAULT 'PENDING',
    "supplierId" TEXT,
    "poItemId" TEXT,
    "notes" TEXT,
    "sortOrder" INTEGER NOT NULL DEFAULT 0,
...
-- CreateTable
CREATE TABLE "zipper_style_associations" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "zipper_style_associations_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "cutting_batches" (
    ...
    "wastagePercent" DECIMAL(5,2),
    "fabricIssued" DECIMAL(10,2),
    "fabricReturned" DECIMAL(10,2),
    "actualConsumption" DECIMAL(10,2),
...
-- CreateTable
CREATE TABLE "cutting_batch_fabrics" (
    "id" TEXT NOT NULL,
    "batchId" TEXT NOT NULL,
    "fabricStockId" TEXT NOT NULL,
    ...
    "actualWidth" DECIMAL(10,2),
    "fabricConsumed" DECIMAL(10,2) NOT NULL DEFAULT 0,
    "fabricIssued" DECIMAL(10,2),
    "fabricReturned" DECIMAL(10,2),
    "actualConsumption" DECIMAL(10,2),
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "cutting_lays" (
    ...
    "numberOfLayers" INTEGER NOT NULL DEFAULT 1,
...
CREATE TABLE "lab_dips" (
    ...
    "buyerApprovalStatus" "BuyerApprovalStatus" NOT NULL DEFAULT 'NOT_SENT',
    "buyerApprovalDate" TIMESTAMP(3),
    "buyerRemarks" TEXT,
...
CREATE TABLE "job_work_orders" (
    ...
    "isRateTbd" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "lace_stock" (
    ...
    "qualityGrade" TEXT NOT NULL DEFAULT 'A',
    "status" "StockStatus" NOT NULL DEFAULT 'AVAILABLE',
    "stockType" "StockEntryType" NOT NULL DEFAULT 'PLANNED_STOCK',
    "receivedDate" TIMESTAMP(3) NOT NULL,
    "lastConsumedDate" TIMESTAMP(3),
    "agingDays" INTEGER NOT NULL DEFAULT 0,
    "returnStatus" TEXT,
...
CREATE TABLE "style_images" (
    ...
    "image_type" "StyleImageType" NOT NULL DEFAULT 'OTHER',
    "caption" TEXT,
    "sort_order" INTEGER NOT NULL DEFAULT 0,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateTable
CREATE TABLE "material_id_map" (
    "old_id" TEXT NOT NULL,
    "new_id" TEXT NOT NULL,
    "material_type" TEXT,
    "action" TEXT NOT NULL,
    "migrated_at" TIMESTAMPTZ(6) DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "material_id_map_pkey" PRIMARY KEY ("old_id")
);
...
-- CreateIndex
CREATE INDEX "order_bom_items_greigeId_idx" ON "order_bom_items"("greigeId");

-- CreateIndex
CREATE INDEX "order_bom_items_processorId_idx" ON "order_bom_items"("processorId");
...
-- CreateIndex
CREATE INDEX "customer_addresses_customerId_addressType_idx" ON "customer_addresses"("customerId", "addressType");
...
-- CreateIndex
CREATE INDEX "delivery_note_fg_allocations_deliveryNoteId_idx" ON "delivery_note_fg_allocations"("deliveryNoteId");

-- CreateIndex
CREATE INDEX "delivery_note_fg_allocations_fgStockId_idx" ON "delivery_note_fg_allocations"("fgStockId");
...
-- CreateIndex
CREATE UNIQUE INDEX "materials_greigeId_key" ON "materials"("greigeId");

-- CreateIndex
CREATE UNIQUE INDEX "materials_fabricId_key" ON "materials"("fabricId");

-- CreateIndex
CREATE UNIQUE INDEX "materials_laceId_key" ON "materials"("laceId");

-- CreateIndex
CREATE UNIQUE INDEX "materials_buttonId_key" ON "materials"("buttonId");

-- CreateIndex
CREATE UNIQUE INDEX "materials_threadId_key" ON "materials"("threadId");

-- CreateIndex
CREATE UNIQUE INDEX "materials_zipperId_key" ON "materials"("zipperId");

-- CreateIndex
CREATE UNIQUE INDEX "materials_elasticId_key" ON "materials"("elasticId");

-- CreateIndex
CREATE UNIQUE INDEX "materials_packagingId_key" ON "materials"("packagingId");

-- CreateIndex
CREATE UNIQUE INDEX "materials_sizeVariantId_key" ON "materials"("sizeVariantId");

-- CreateIndex
CREATE UNIQUE INDEX "materials_machinePartId_key" ON "materials"("machinePartId");

-- CreateIndex
CREATE UNIQUE INDEX "materials_otherMaterialId_key" ON "materials"("otherMaterialId");

-- CreateIndex
CREATE UNIQUE INDEX "materials_hookEyeId_key" ON "materials"("hookEyeId");

-- CreateIndex
CREATE UNIQUE INDEX "materials_snapButtonId_key" ON "materials"("snapButtonId");

-- CreateIndex
CREATE UNIQUE INDEX "materials_buckleId_key" ON "materials"("buckleId");

-- CreateIndex
CREATE UNIQUE INDEX "materials_beltId_key" ON "materials"("beltId");

-- CreateIndex
CREATE UNIQUE INDEX "materials_velcroId_key" ON "materials"("velcroId");

-- CreateIndex
CREATE UNIQUE INDEX "materials_drawstringId_key" ON "materials"("drawstringId");

-- CreateIndex
CREATE UNIQUE INDEX "materials_ribbonId_key" ON "materials"("ribbonId");

-- CreateIndex
CREATE UNIQUE INDEX "materials_sequinId_key" ON "materials"("sequinId");

-- CreateIndex
CREATE UNIQUE INDEX "materials_beadId_key" ON "materials"("beadId");

-- CreateIndex
CREATE UNIQUE INDEX "materials_motifId_key" ON "materials"("motifId");

-- CreateIndex
CREATE UNIQUE INDEX "materials_interliningId_key" ON "materials"("interliningId");

-- CreateIndex
CREATE UNIQUE INDEX "materials_paddingId_key" ON "materials"("paddingId");

-- CreateIndex
CREATE UNIQUE INDEX "materials_otherFastenerId_key" ON "materials"("otherFastenerId");

-- CreateIndex
CREATE UNIQUE INDEX "materials_otherTapeId_key" ON "materials"("otherTapeId");

-- CreateIndex
CREATE UNIQUE INDEX "materials_otherDecorativeId_key" ON "materials"("otherDecorativeId");

-- CreateIndex
CREATE UNIQUE INDEX "materials_otherFunctionalId_key" ON "materials"("otherFunctionalId");
...
-- CreateIndex
CREATE INDEX "purchase_order_items_serviceType_idx" ON "purchase_order_items"("serviceType");
...
-- CreateIndex
CREATE INDEX "purchase_orders_poSource_idx" ON "purchase_orders"("poSource");

-- CreateIndex
CREATE INDEX "purchase_orders_mrpBatchId_idx" ON "purchase_orders"("mrpBatchId");

-- CreateIndex
CREATE INDEX "purchase_orders_serviceWorkOrderId_idx" ON "purchase_orders"("serviceWorkOrderId");
...
-- CreateIndex
CREATE INDEX "processor_rate_card_processorId_processingType_effectiveFro_idx" ON "processor_rate_card"("processorId", "processingType", "effectiveFrom");

-- CreateIndex
CREATE INDEX "processor_rate_card_effectiveTo_idx" ON "processor_rate_card"("effectiveTo");

-- CreateIndex
CREATE UNIQUE INDEX "processor_rate_card_processorId_processingType_printingType_key" ON "processor_rate_card"("processorId", "processingType", "printingType", "greigeId", "laceId", "slabId", "effectiveFrom");

-- CreateIndex
CREATE INDEX "processor_rate_change_log_processorId_changedAt_idx" ON "processor_rate_change_log"("processorId", "changedAt");

-- CreateIndex
CREATE INDEX "processor_rate_change_log_changedAt_idx" ON "processor_rate_change_log"("changedAt");

-- CreateIndex
CREATE INDEX "processor_rate_change_log_greigeId_idx" ON "processor_rate_change_log"("greigeId");

-- CreateIndex
CREATE INDEX "processor_rate_change_log_laceId_idx" ON "processor_rate_change_log"("laceId");
...
-- CreateIndex
CREATE UNIQUE INDEX "permission_definitions_permissionKey_key" ON "permission_definitions"("permissionKey");

-- CreateIndex
CREATE INDEX "permission_definitions_moduleGroup_idx" ON "permission_definitions"("moduleGroup");

-- CreateIndex
CREATE INDEX "permission_definitions_isActive_idx" ON "permission_definitions"("isActive");
...
-- CreateIndex
CREATE INDEX "sale_orders_styleId_idx" ON "sale_orders"("styleId");
...
-- CreateIndex
CREATE INDEX "stock_settings_materialId_idx" ON "stock_settings"("materialId");

-- CreateIndex
CREATE UNIQUE INDEX "stock_settings_materialId_warehouseId_key" ON "stock_settings"("materialId", "warehouseId");
...
-- CreateIndex
CREATE INDEX "material_requirements_requirementType_idx" ON "material_requirements"("requirementType");

-- CreateIndex
CREATE INDEX "material_requirements_processorId_idx" ON "material_requirements"("processorId");

-- CreateIndex
CREATE INDEX "material_requirements_linkedRequirementId_idx" ON "material_requirements"("linkedRequirementId");
...
-- CreateIndex
CREATE INDEX "po_source_links_purchaseOrderId_idx" ON "po_source_links"("purchaseOrderId");

-- CreateIndex
CREATE INDEX "po_source_links_purchaseOrderItemId_idx" ON "po_source_links"("purchaseOrderItemId");

-- CreateIndex
CREATE INDEX "po_source_links_sourceType_idx" ON "po_source_links"("sourceType");

-- CreateIndex
CREATE INDEX "po_source_links_materialRequirementId_idx" ON "po_source_links"("materialRequirementId");

-- CreateIndex
CREATE INDEX "po_source_links_serviceRequirementId_idx" ON "po_source_links"("serviceRequirementId");

-- CreateIndex
CREATE INDEX "po_source_links_costSheetGenerationId_idx" ON "po_source_links"("costSheetGenerationId");
...
-- CreateIndex
CREATE UNIQUE INDEX "greige_master_greigeCode_key" ON "greige_master"("greigeCode");
...
-- CreateIndex
CREATE INDEX "greige_stock_greigeId_idx" ON "greige_stock"("greigeId");

-- CreateIndex
CREATE INDEX "greige_stock_warehouseId_idx" ON "greige_stock"("warehouseId");

-- CreateIndex
CREATE INDEX "greige_stock_status_idx" ON "greige_stock"("status");

-- CreateIndex
CREATE INDEX "greige_stock_receivedDate_idx" ON "greige_stock"("receivedDate");
...
-- CreateIndex
CREATE UNIQUE INDEX "fabric_master_fabricCode_key" ON "fabric_master"("fabricCode");
...
-- CreateIndex
CREATE INDEX "fabric_width_cad_costing_run_id_idx" ON "fabric_width_cad"("costing_run_id");
...
-- CreateIndex
CREATE INDEX "fabric_costing_run_styleId_purpose_idx" ON "fabric_costing_run"("styleId", "purpose");

-- CreateIndex
CREATE INDEX "fabric_costing_run_createdAt_idx" ON "fabric_costing_run"("createdAt");

-- CreateIndex
CREATE UNIQUE INDEX "fabric_costing_run_styleId_purpose_runNumber_key" ON "fabric_costing_run"("styleId", "purpose", "runNumber");
...
-- CreateIndex
CREATE INDEX "fabric_processing_processorId_greigeId_idx" ON "fabric_processing"("processorId", "greigeId");
...
-- CreateIndex
CREATE UNIQUE INDEX "lace_master_laceCode_key" ON "lace_master"("laceCode");
...
-- CreateIndex
CREATE INDEX "lace_master_processedForStyleId_idx" ON "lace_master"("processedForStyleId");

-- CreateIndex
CREATE UNIQUE INDEX "button_master_buttonCode_key" ON "button_master"("buttonCode");

-- CreateIndex
CREATE INDEX "button_master_supplierId_idx" ON "button_master"("supplierId");

-- CreateIndex
CREATE UNIQUE INDEX "thread_master_threadCode_key" ON "thread_master"("threadCode");
...
-- CreateIndex
CREATE INDEX "zipper_style_associations_zipperId_idx" ON "zipper_style_associations"("zipperId");

-- CreateIndex
CREATE INDEX "zipper_style_associations_styleId_idx" ON "zipper_style_associations"("styleId");

-- CreateIndex
CREATE UNIQUE INDEX "zipper_style_associations_zipperId_styleId_key" ON "zipper_style_associations"("zipperId", "styleId");

-- CreateIndex
CREATE UNIQUE INDEX "zipper_master_zipperCode_key" ON "zipper_master"("zipperCode");

-- CreateIndex
CREATE INDEX "zipper_master_supplierId_idx" ON "zipper_master"("supplierId");

-- CreateIndex
CREATE UNIQUE INDEX "elastic_master_elasticCode_key" ON "elastic_master"("elasticCode");

-- CreateIndex
CREATE INDEX "elastic_master_supplierId_idx" ON "elastic_master"("supplierId");

-- CreateIndex
CREATE UNIQUE INDEX "label_master_labelCode_key" ON "label_master"("labelCode");
...
-- CreateIndex
CREATE UNIQUE INDEX "packaging_master_packagingCode_key" ON "packaging_master"("packagingCode");
...
-- CreateIndex
CREATE UNIQUE INDEX "machine_part_master_partCode_key" ON "machine_part_master"("partCode");
...
-- CreateIndex
CREATE UNIQUE INDEX "other_material_master_materialCode_key" ON "other_material_master"("materialCode");
...
-- CreateIndex
CREATE UNIQUE INDEX "cutting_batch_fabrics_batchId_fabricStockId_key" ON "cutting_batch_fabrics"("batchId", "fabricStockId");
...
-- CreateIndex
CREATE UNIQUE INDEX "transfer_slips_slipNumber_key" ON "transfer_slips"("slipNumber");
...
-- CreateIndex
CREATE INDEX "job_work_orders_processorId_idx" ON "job_work_orders"("processorId");
...
-- CreateIndex
CREATE INDEX "job_work_orders_grnId_idx" ON "job_work_orders"("grnId");
...
-- CreateIndex
CREATE UNIQUE INDEX "hook_eye_master_hookEyeCode_key" ON "hook_eye_master"("hookEyeCode");

-- CreateIndex
CREATE INDEX "hook_eye_master_supplierId_idx" ON "hook_eye_master"("supplierId");

-- CreateIndex
CREATE UNIQUE INDEX "snap_button_master_snapButtonCode_key" ON "snap_button_master"("snapButtonCode");

-- CreateIndex
CREATE INDEX "snap_button_master_supplierId_idx" ON "snap_button_master"("supplierId");

-- CreateIndex
CREATE UNIQUE INDEX "buckle_master_buckleCode_key" ON "buckle_master"("buckleCode");

-- CreateIndex
CREATE INDEX "buckle_master_supplierId_idx" ON "buckle_master"("supplierId");

-- CreateIndex
CREATE UNIQUE INDEX "belt_master_beltCode_key" ON "belt_master"("beltCode");

-- CreateIndex
CREATE INDEX "belt_master_supplierId_idx" ON "belt_master"("supplierId");

-- CreateIndex
CREATE UNIQUE INDEX "velcro_master_velcroCode_key" ON "velcro_master"("velcroCode");

-- CreateIndex
CREATE INDEX "velcro_master_supplierId_idx" ON "velcro_master"("supplierId");

-- CreateIndex
CREATE UNIQUE INDEX "drawstring_master_drawstringCode_key" ON "drawstring_master"("drawstringCode");

-- CreateIndex
CREATE INDEX "drawstring_master_supplierId_idx" ON "drawstring_master"("supplierId");

-- CreateIndex
CREATE UNIQUE INDEX "ribbon_master_ribbonCode_key" ON "ribbon_master"("ribbonCode");

-- CreateIndex
CREATE INDEX "ribbon_master_supplierId_idx" ON "ribbon_master"("supplierId");

-- CreateIndex
CREATE UNIQUE INDEX "sequin_master_sequinCode_key" ON "sequin_master"("sequinCode");

-- CreateIndex
CREATE INDEX "sequin_master_supplierId_idx" ON "sequin_master"("supplierId");

-- CreateIndex
CREATE UNIQUE INDEX "bead_master_beadCode_key" ON "bead_master"("beadCode");

-- CreateIndex
CREATE INDEX "bead_master_supplierId_idx" ON "bead_master"("supplierId");

-- CreateIndex
CREATE UNIQUE INDEX "motif_master_motifCode_key" ON "motif_master"("motifCode");

-- CreateIndex
CREATE INDEX "motif_master_supplierId_idx" ON "motif_master"("supplierId");

-- CreateIndex
CREATE UNIQUE INDEX "interlining_master_interliningCode_key" ON "interlining_master"("interliningCode");

-- CreateIndex
CREATE INDEX "interlining_master_supplierId_idx" ON "interlining_master"("supplierId");

-- CreateIndex
CREATE UNIQUE INDEX "padding_master_paddingCode_key" ON "padding_master"("paddingCode");

-- CreateIndex
CREATE INDEX "padding_master_supplierId_idx" ON "padding_master"("supplierId");

-- CreateIndex
CREATE UNIQUE INDEX "other_fastener_master_otherFastenerCode_key" ON "other_fastener_master"("otherFastenerCode");

-- CreateIndex
CREATE INDEX "other_fastener_master_supplierId_idx" ON "other_fastener_master"("supplierId");

-- CreateIndex
CREATE UNIQUE INDEX "other_tape_master_otherTapeCode_key" ON "other_tape_master"("otherTapeCode");

-- CreateIndex
CREATE INDEX "other_tape_master_supplierId_idx" ON "other_tape_master"("supplierId");

-- CreateIndex
CREATE UNIQUE INDEX "other_decorative_master_otherDecorativeCode_key" ON "other_decorative_master"("otherDecorativeCode");

-- CreateIndex
CREATE INDEX "other_decorative_master_supplierId_idx" ON "other_decorative_master"("supplierId");

-- CreateIndex
CREATE UNIQUE INDEX "other_functional_master_otherFunctionalCode_key" ON "other_functional_master"("otherFunctionalCode");
...
-- CreateIndex
CREATE INDEX "style_comments_style_id_idx" ON "style_comments"("style_id");

-- CreateIndex
CREATE INDEX "style_comments_user_id_idx" ON "style_comments"("user_id");

-- CreateIndex
CREATE INDEX "style_comments_parent_id_idx" ON "style_comments"("parent_id");

-- CreateIndex
CREATE INDEX "mood_boards_season_id_idx" ON "mood_boards"("season_id");

-- CreateIndex
CREATE INDEX "mood_boards_created_by_id_idx" ON "mood_boards"("created_by_id");

-- CreateIndex
CREATE INDEX "mood_boards_status_idx" ON "mood_boards"("status");

-- CreateIndex
CREATE INDEX "mood_board_items_mood_board_id_idx" ON "mood_board_items"("mood_board_id");

-- CreateIndex
CREATE UNIQUE INDEX "style_tech_specs_style_id_key" ON "style_tech_specs"("style_id");
...
-- CreateIndex
CREATE INDEX "challans_fabricProcessingId_idx" ON "challans"("fabricProcessingId");
...
-- CreateIndex
CREATE INDEX "challan_items_greigeStockId_idx" ON "challan_items"("greigeStockId");

-- CreateIndex
CREATE INDEX "challan_items_fabricStockId_idx" ON "challan_items"("fabricStockId");

-- CreateIndex
CREATE INDEX "challan_items_laceStockId_idx" ON "challan_items"("laceStockId");

-- CreateIndex
CREATE INDEX "challan_items_threadStockId_idx" ON "challan_items"("threadStockId");

-- CreateIndex
CREATE INDEX "challan_items_materialRequirementId_idx" ON "challan_items"("materialRequirementId");

-- CreateIndex
CREATE INDEX "challan_items_serviceRequirementId_idx" ON "challan_items"("serviceRequirementId");
...
-- CreateIndex
CREATE INDEX "tds_entries_invoiceId_idx" ON "tds_entries"("invoiceId");

-- CreateIndex
CREATE INDEX "tds_entries_financialYear_quarter_idx" ON "tds_entries"("financialYear", "quarter");

-- CreateIndex
CREATE INDEX "tds_entries_status_idx" ON "tds_entries"("status");

-- CreateIndex
CREATE INDEX "tcs_entries_invoiceId_idx" ON "tcs_entries"("invoiceId");

-- CreateIndex
CREATE INDEX "tcs_entries_financialYear_quarter_idx" ON "tcs_entries"("financialYear", "quarter");

-- CreateIndex
CREATE INDEX "tcs_entries_status_idx" ON "tcs_entries"("status");
...
-- AddForeignKey
ALTER TABLE "order_bom_items" ADD CONSTRAINT "order_bom_items_greigeId_fkey" FOREIGN KEY ("greigeId") REFERENCES "greige_master"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "order_bom_items" ADD CONSTRAINT "order_bom_items_processorId_fkey" FOREIGN KEY ("processorId") REFERENCES "suppliers"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "order_bom_items" ADD CONSTRAINT "order_bom_items_rateCardId_fkey" FOREIGN KEY ("rateCardId") REFERENCES "processor_rate_card"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "customer_addresses" ADD CONSTRAINT "customer_addresses_stateId_fkey" FOREIGN KEY ("stateId") REFERENCES "indian_states"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "customer_addresses" ADD CONSTRAINT "customer_addresses_cityId_fkey" FOREIGN KEY ("cityId") REFERENCES "indian_cities"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "delivery_note_fg_allocations" ADD CONSTRAINT "delivery_note_fg_allocations_deliveryNoteId_fkey" FOREIGN KEY ("deliveryNoteId") REFERENCES "delivery_notes"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "delivery_note_fg_allocations" ADD CONSTRAINT "delivery_note_fg_allocations_fgStockId_fkey" FOREIGN KEY ("fgStockId") REFERENCES "finished_goods_stock"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "purchase_orders" ADD CONSTRAINT "purchase_orders_serviceWorkOrderId_fkey" FOREIGN KEY ("serviceWorkOrderId") REFERENCES "work_orders"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "style_costing_fabric_items" ADD CONSTRAINT "style_costing_fabric_items_fabricId_fkey" FOREIGN KEY ("fabricId") REFERENCES "fabric_master"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "processor_rate_card" ADD CONSTRAINT "processor_rate_card_supersededById_fkey" FOREIGN KEY ("supersededById") REFERENCES "processor_rate_card"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "processor_rate_change_log" ADD CONSTRAINT "processor_rate_change_log_changedById_fkey" FOREIGN KEY ("changedById") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "sale_orders" ADD CONSTRAINT "sale_orders_styleId_fkey" FOREIGN KEY ("styleId") REFERENCES "styles"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "material_requirements" ADD CONSTRAINT "material_requirements_processorId_fkey" FOREIGN KEY ("processorId") REFERENCES "suppliers"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "material_requirements" ADD CONSTRAINT "material_requirements_linkedRequirementId_fkey" FOREIGN KEY ("linkedRequirementId") REFERENCES "material_requirements"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "po_source_links" ADD CONSTRAINT "po_source_links_purchaseOrderId_fkey" FOREIGN KEY ("purchaseOrderId") REFERENCES "purchase_orders"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "po_source_links" ADD CONSTRAINT "po_source_links_purchaseOrderItemId_fkey" FOREIGN KEY ("purchaseOrderItemId") REFERENCES "purchase_order_items"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "po_source_links" ADD CONSTRAINT "po_source_links_costSheetGenerationId_fkey" FOREIGN KEY ("costSheetGenerationId") REFERENCES "cost_sheet_po_generation"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "po_source_links" ADD CONSTRAINT "po_source_links_materialRequirementId_fkey" FOREIGN KEY ("materialRequirementId") REFERENCES "material_requirements"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "po_source_links" ADD CONSTRAINT "po_source_links_serviceRequirementId_fkey" FOREIGN KEY ("serviceRequirementId") REFERENCES "work_order_service_requirements"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "greige_stock" ADD CONSTRAINT "greige_stock_greigeId_fkey" FOREIGN KEY ("greigeId") REFERENCES "greige_master"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "greige_stock" ADD CONSTRAINT "greige_stock_procurementId_fkey" FOREIGN KEY ("procurementId") REFERENCES "fabric_procurement"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "greige_stock" ADD CONSTRAINT "greige_stock_supplierId_fkey" FOREIGN KEY ("supplierId") REFERENCES "suppliers"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "greige_stock" ADD CONSTRAINT "greige_stock_processorId_fkey" FOREIGN KEY ("processorId") REFERENCES "suppliers"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "greige_stock" ADD CONSTRAINT "greige_stock_sourceChallanId_fkey" FOREIGN KEY ("sourceChallanId") REFERENCES "challans"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "greige_stock" ADD CONSTRAINT "greige_stock_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "fabric_width_cad" ADD CONSTRAINT "fabric_width_cad_costing_run_id_fkey" FOREIGN KEY ("costing_run_id") REFERENCES "fabric_costing_run"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "fabric_costing_run" ADD CONSTRAINT "fabric_costing_run_styleId_fkey" FOREIGN KEY ("styleId") REFERENCES "styles"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "fabric_costing_run" ADD CONSTRAINT "fabric_costing_run_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "fabric_processing" ADD CONSTRAINT "fabric_processing_processorId_fkey" FOREIGN KEY ("processorId") REFERENCES "suppliers"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "zipper_style_associations" ADD CONSTRAINT "zipper_style_associations_styleId_fkey" FOREIGN KEY ("styleId") REFERENCES "styles"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "zipper_style_associations" ADD CONSTRAINT "zipper_style_associations_zipperId_fkey" FOREIGN KEY ("zipperId") REFERENCES "zipper_master"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "cutting_batch_fabrics" ADD CONSTRAINT "cutting_batch_fabrics_batchId_fkey" FOREIGN KEY ("batchId") REFERENCES "cutting_batches"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "cutting_batch_fabrics" ADD CONSTRAINT "cutting_batch_fabrics_fabricStockId_fkey" FOREIGN KEY ("fabricStockId") REFERENCES "fabric_stock"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "cutting_lays" ADD CONSTRAINT "cutting_lays_cuttingBatchFabricId_fkey" FOREIGN KEY ("cuttingBatchFabricId") REFERENCES "cutting_batch_fabrics"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "lab_dips" ADD CONSTRAINT "lab_dips_processorId_fkey" FOREIGN KEY ("processorId") REFERENCES "suppliers"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "job_work_orders" ADD CONSTRAINT "job_work_orders_labDipId_fkey" FOREIGN KEY ("labDipId") REFERENCES "lab_dips"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "job_work_orders" ADD CONSTRAINT "job_work_orders_processorId_fkey" FOREIGN KEY ("processorId") REFERENCES "suppliers"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "job_work_orders" ADD CONSTRAINT "job_work_orders_grnId_fkey" FOREIGN KEY ("grnId") REFERENCES "goods_receiving_notes"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "style_comments" ADD CONSTRAINT "style_comments_style_id_fkey" FOREIGN KEY ("style_id") REFERENCES "styles"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "style_comments" ADD CONSTRAINT "style_comments_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "style_comments" ADD CONSTRAINT "style_comments_parent_id_fkey" FOREIGN KEY ("parent_id") REFERENCES "style_comments"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "mood_boards" ADD CONSTRAINT "mood_boards_season_id_fkey" FOREIGN KEY ("season_id") REFERENCES "season_master"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "mood_boards" ADD CONSTRAINT "mood_boards_created_by_id_fkey" FOREIGN KEY ("created_by_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "style_tech_specs" ADD CONSTRAINT "style_tech_specs_style_id_fkey" FOREIGN KEY ("style_id") REFERENCES "styles"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- derived_stock_view (raw SQL object — not expressible in schema.prisma; definition
-- captured from the live DB at baseline time; original authored in migrations
-- 20260719000000/20260720120000, archived in prisma/migrations_archive_20260804)
CREATE VIEW derived_stock_view AS
 WITH per_lot AS (
         SELECT m.id AS "materialId",
          ...
          WHERE s."warehouseId" IS NOT NULL AND s."processorId" IS NULL AND s."sourceType"::text IS DISTINCT FROM 'TRANSFER'::text
