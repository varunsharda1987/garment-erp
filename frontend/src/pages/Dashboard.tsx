  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">Here's what's happening with your garment manufacturing operations today.</p>
      </div>
      ...
      <Card className="mb-8">
        ...
        <CardContent>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            <Button variant="outline" className="h-auto py-4" onClick={() => navigate('/users')}>
            ...
            <Button variant="outline" className="h-auto py-4" onClick={() => navigate('/styles')}>
              <div className="text-center">
                <div className="text-2xl mb-1">👔</div>
            ...
            <Button variant="outline" className="h-auto py-4" onClick={() => navigate('/customers')}>
              <div className="text-center">
                <div className="text-2xl mb-1">🤝</div>
            ...
            <Button variant="outline" className="h-auto py-4" onClick={() => navigate('/suppliers')}>
              <div className="text-center">
                <div className="text-2xl mb-1">🏢</div>
            ...
            <Button variant="outline" className="h-auto py-4" onClick={() => navigate('/material-master')}>
              <div className="text-center">
                <div className="text-2xl mb-1">📦</div>
            ...
            <Button variant="outline" className="h-auto py-4" onClick={() => navigate('/orders')}>
              <div className="text-center">
                <div className="text-2xl mb-1">📋</div>
            ...
            <Button variant="outline" className="h-auto py-4" onClick={() => navigate('/order-bom')}>
              <div className="text-center">
                <div className="text-2xl mb-1">📊</div>
            ...
            <Button variant="outline" className="h-auto py-4" onClick={() => navigate('/cost-sheets')}>
              <div className="text-center">
                <div className="text-2xl mb-1">💰</div>
            ...
            <Button variant="outline" className="h-auto py-4" onClick={() => navigate('/chart-of-accounts')}>
              <div className="text-center">
                <div className="text-2xl mb-1">💼</div>
            ...
            <Button variant="outline" className="h-auto py-4" onClick={() => navigate('/inventory/dashboard')}>
              <div className="text-center">
                <div className="text-2xl mb-1">📦</div>
            ...
            <Button variant="outline" className="h-auto py-4" onClick={() => navigate('/production/work-orders')}>
              <div className="text-center">
                <div className="text-2xl mb-1">🏭</div>
