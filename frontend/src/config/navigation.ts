...
export const NAV_GROUPS: NavGroup[] = [
  ...
  // 4. Manufacturing
  {
    ...
    items: [
      ...
      {
        title: 'Processor Statement',
        path: '/processing/processor-statement',
        iconName: 'FileCheck',
        permission: 'jobWork',
        keywords: [
          'reconciliation',
      ...
      {
        title: 'Test Requirement Forms',
        path: '/test-requirement-forms',
  ...
  // 5. Inventory
  {
    ...
    items: [
      ...
      },
      {
        ...
        path: '/inventory/material-ledger',
        iconName: 'BookOpen',
        permission: 'stockMovements',
        keywords: [
          'ledger',
  ...
  // messaging items; admin items are hidden by their item-level permissions.
  {
    ...
    items: [
      ...
      'divider',
      {
        // Deliberately NO permission: every user reaches Change Password here. The admin-only
        // sections (company profile, system defaults, integrations) hide themselves.
        title: 'Settings',
        path: '/settings',
        iconName: 'Settings',
        keywords: [
...
export const SEARCH_ONLY_ITEMS: FlatNavItem[] = [
  ...
  // Reached from the Settings hub; searchable by the statutory numbers people look for.
  {
