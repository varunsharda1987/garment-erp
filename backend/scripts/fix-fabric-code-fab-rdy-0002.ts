/**
 * One-time data fix: update FAB-RDY-0002 → FAB-EMFK00262-001
 * and sync the corresponding materials record.
 *
 * Run: cd backend && npx ts-node scripts/fix-fabric-code-fab-rdy-0002.ts
 */
...
async function fixFabricCode() {
  const OLD_CODE = 'FAB-RDY-0002';
  const NEW_CODE = 'FAB-EMFK00262-001';
